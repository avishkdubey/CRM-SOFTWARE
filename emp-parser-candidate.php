...
<body class="bg-white">
    ...
    <div class="container">
        ...
        <hr>
        <form method="post" action="resume_parser.php" enctype="multipart/form-data">
            <div class="row p-3">
                <center>
                    <div class="col-md-5 p-3 m-5 bg-light" style="border:2px solid black; border-radius:5px;">
                        <center>
                            ...
                            <p style="font-size:1.8vh;"><a href="">CLICK HERE</a> to view the Workart excel sheet format.</p>
