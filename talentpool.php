...
<body class="bg-white">
    ...
    <div class="container-fluid bg-white">
        <div class="row p-2">
            <div class="col-md-10"><h4>Active Jobs</h4></div>
            <div class="col-md-2">
                <center><div class="card" style="border:2px solid #1EBC30; background-color:#E5F9E7; height:5vh;"><span><strong>Total Candidates</strong> : <strong>5824</strong></span></div></center>
            </div>
        </div>
        <hr>
        <div class="row">
            <table class="table table-striped">
                ...
                <tbody>
                    <tr>
                        ...
                        <td>Male</td>
                        <td>30</td>
                        <td>Senior Relationship Manager at HDFC Securities Jan, 2022 - Present</td>
                        <td>Deputy Manager at kotak Securities Dec, 2020 - Jan, 2022</td>
                        <td>B.B.A/ B.M.S, Sinhagad institution Of Business Management 2015</td>
                        <td>Jaipur</td>
                        <td>B2B Sales , sales, Sales & Field Activities</td>
